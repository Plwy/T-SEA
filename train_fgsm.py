...
if __name__ == '__main__':
    ...
    cfg = ConfigParser(args.cfg) # 加载配置
    detector_attacker = UniversalAttacker(cfg, device) # 生成初始patch，patch转换配置，检测器初始化
    cfg.show_class_label(cfg.attack_list) # 返回指定攻击的检测类别
    attack(cfg, detector_attacker, save_patch_name, args) # 对抗补丁训练生成
